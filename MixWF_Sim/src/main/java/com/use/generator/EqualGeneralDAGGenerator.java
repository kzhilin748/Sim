...
public class EqualGeneralDAGGenerator extends EqualForkJoinDAGGenerator {

	private Random randomNumber = new Random();	
	
	public EqualGeneralDAGGenerator() {
	...
	public List<IAttribute> generate() throws Exception {
		...
		computationTime = DAGVariable.getInstance().getMinComputationTime()+randomNumber.nextInt(1+DAGVariable.getInstance().getMaxComputationTime()-DAGVariable.getInstance().getMinComputationTime());
